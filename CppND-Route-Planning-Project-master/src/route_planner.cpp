...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    RouteModel::Node * node_path=current_node;
    
    // TODO: Implement your solution here.
    while(1){

        path_found.insert(path_found.begin(),*node_path);
        if(node_path->parent!=nullptr){
            distance=distance+node_path->distance(*node_path->parent);
